...
<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
                                        ...
                                        <div class="kt-widget__top">
                                             <div class="kt-widget__media kt-hidden-">
                                                  <?php if ($customer->passport == TRUE) {
                                                       ...
                                                       <img src="<?php echo base_url(); ?>assets/img/male.jpeg" alt="passport"
                                             ...
                                             <div class="kt-widget__content">
                                                  <div class="kt-widget__head">
                                                       <a href="javascript:;" class="kt-widget__username">
                                                            <b class="c"><?php echo $customer->f_name; ?>
                                                                 <?php echo $customer->m_name; ?>
                                                                 <?php echo $customer->l_name; ?> </b>
                                                            <i class=""></i>
                                                       </a>
                                                       ...
                                                       <div class="kt-widget__action">
                                                            <div class="">
                                                                 <?php if ($customer->signature == TRUE) {
                                                                      ...
                                                                      <img src="<?php echo base_url(); ?>assets/img/sig.jpg"
                                                                           alt="passport" style="width: 200px; height: 180px;">
                                                                 <?php } else { ?>
                                                                      <img src="<?php echo base_url(); ?>assets/img/sig.jpg"
                                                                           alt="passport" style="width: 200px; height: 180px;">
                                                                 <?php } ?>
                        ...
                        <a href="#"><i class="flaticon2-placeholder"></i>Melbourne</a>
                                                  ...
                                                  <table
                                                       ...
                                                       <tbody>
                                                            <tr>
                                                                 ...
                                                                 <td><?php echo number_format(@$deposts->total_depost); ?>
                                                                 </td>
                                                                 <td><?php echo number_format(@$withdraw->total_withdraw); ?>
                                                                 </td>
                                                                 <td>
                                                                      <?php echo number_format($blanch_amount_balance->total_blanch_capital); ?>
                                   ...
                                   <div class="text-right">
                                        <?php if (@$customer_loan->loan_status == 'withdrawal' || @$customer_loan->loan_status == 'out') {
                                             ?>
                                             <a href="" class="btn btn-success" class="kt-nav__link" data-toggle="modal"
                                                  data-target="#kt_modal_<?php //echo $blanchs->blanch_id; ?>"><i
                                                       class="kt-menu__link-icon flaticon2-add"></i>Deposit</a>
                                        <?php } elseif (@$customer_loan->loan_status == 'disbarsed') {
                                             ?>

                                             <a href="" class="btn btn-brand" class="kt-nav__link" data-toggle="modal"
                                                  data-target="#kt_modal_2"><i
                                                       class="kt-menu__link-icon flaticon2-files-and-folders"></i>Withdrawal</a>
                                        ...
                                        <a href="" class="btn btn-info" class="kt-nav__link" data-toggle="modal"
                                             data-target="#kt_modal_4"><i
                                                  class="kt-menu__link-icon flaticon2-search-1"></i>Search</a>
                                   </div>
                              </div>
                                        ...
                                        <tr>
                                             ...
                                             <td class="c"> <?php echo $payisnulls->emply; ?>
                                                  ...
                                                  <?php if ($payisnulls->fee_id == TRUE || $payisnulls->fee_id == '0') {
                                                       ...
                                                       <?php echo $payisnulls->fee_percentage; ?>                <?php echo $payisnulls->symbol; ?>
                                                  <?php } else { ?>
                                                  <?php } ?>
     ...
     <?php } else { ?>
          <div class="text-center">
               <h1>
                    <br><br><br>
                    OOPS! There no customer with that name
               </h1>
                    ...
                    <div class="form-group">
                         <div class="row">
                              <div class="col-lg-4">
                                   ...
                                   <input type="" name="" id="amount_1a" min="1" readonly value="10000"
                                        class="form-control"
                                        style="width: 130px; height:30px;border: none; color: #2ccff4;">
                              </div>
                              <div class="col-lg-4">
                                   <label for="recipient-name" class="form-control-label">*Quantity</label>
                                   <input type="number" name="" min="1" id="qnty_1a" class="form-control"
                                        style="width: 130px; height:30px;border-radius: 5px;">
                              </div>
                              <div class="col-lg-4">
                                   <label for="recipient-name" min="1" class="form-control-label">Total Amount</label>
                                   <input type="" name="" value="" autocomplete="off" id="jumla_1a" class="form-control"
                                        style="width: 130px; height:30px;border: none; color: blue;">
                              </div>



                              <div class="col-lg-4">
                                   <input type="" name="" value="5000" min="1" id="amount_2a" readonly
                                        class="form-control"
                                        style="width: 130px; height:30px;border: none; color: #2ccff4;">
                              </div>
                              <div class="col-lg-4">
                                   <input type="number" name="" min="1" id="qnty_2a" class="form-control"
                                        style="width: 130px; height:30px;border: radius;border-radius: 5px;">
                              </div>
                              <div class="col-lg-4">
                                   <input type="" name="" id="jumla_2a" min="1" autocomplete="off" class="form-control"
                                        style="width: 130px; height:30px;border: none; color: blue;">
                              </div>

                              <div class="col-lg-4">
                                   <input type="" name="" value="2000" min="1" id="amount_3a" readonly
                                        class="form-control"
                                        style="width: 130px; height:30px;border: none; color: #2ccff4;">
                              </div>
                              <div class="col-lg-4">
                                   <input type="number" name="" min="1" id="qnty_3a" class="form-control"
                                        style="width: 130px; height:30px;border-radius: 5px;">
                              </div>
                              <div class="col-lg-4">
                                   <input type="" name="" id="jumla_3a" min="1" autocomplete="off" class="form-control"
                                        style="width: 130px; height:30px;border: none; color: blue;">
                              </div>


                              <div class="col-lg-4">
                                   <input type="" name="" value="1000" min="1" id="amount_4a" readonly
                                        class="form-control"
                                        style="width: 130px; height:30px;border: none; color: #2ccff4;">
                              </div>
                              <div class="col-lg-4">
                                   <input type="number" name="" min="1" id="qnty_4a" class="form-control"
                                        style="width: 130px; height:30px;border-radius: 5px;">
                              </div>
                              <div class="col-lg-4">
                                   <input type="" name="" value="" min="1" id="jumla_4a" autocomplete="off"
                                        class="form-control"
                                        style="width: 130px; height:30px;border: none; color: blue;">
                              </div>
                              ...
                              <div class="col-lg-4">
                                   <input type="" name="" value="500" min="1" id="amount_5a" readonly
                                        class="form-control"
                                        style="width: 130px; height:30px;border: none; color: #2ccff4;">
                              </div>
                              <div class="col-lg-4">
                                   <input type="number" name="" min="1" id="qnty_5a" class="form-control"
                                        style="width: 130px; height:30px;border-radius: 5px;">
                              </div>
                              <div class="col-lg-4">
                                   <input type="" name="" value="" min="1" id="jumla_5a" autocomplete="off"
                                        class="form-control"
                                        style="width: 130px; height:30px;border: none; color: blue;">
                              </div>
                              ...
                              <div class="col-lg-4">
                                   <input type="" name="" value="200" min="1" id="amount_6a" readonly
                                        class="form-control"
                                        style="width: 130px; height:30px;border: none; color: #2ccff4;">
                              </div>
                              <div class="col-lg-4">
                                   <input type="number" name="" min="1" id="qnty_6a" class="form-control"
                                        style="width: 130px; height:30px;border-radius: 5px;">
                              </div>
                              <div class="col-lg-4">
                                   <input type="" name="" value="" min="1" id="jumla_6a" autocomplete="off"
                                        class="form-control"
                                        style="width: 130px; height:30px;border: none; color: blue;">
                              </div>
                              ...
                              <div class="col-lg-4">
                                   <input type="" name="" value="100" min="1" id="amount_7a" readonly
                                        class="form-control"
                                        style="width: 130px; height:30px;border: none; color: #2ccff4;">
                              </div>
                              <div class="col-lg-4">

                                   <input type="number" name="" min="1" id="qnty_7a" class="form-control"
                                        style="width: 130px; height:30px;border-radius: 5px;">
                              </div>
                              <div class="col-lg-4">

                                   <input type="" name="" value="" min="1" id="jumla_7a" autocomplete="off"
                                        class="form-control"
                                        style="width: 130px; height:30px;border: none; color: blue;">
                              </div>
                              ...
                              <div class="col-lg-4">
                                   <input type="" name="" value="50" min="1" id="amount_8a" readonly
                                        class="form-control"
                                        style="width: 130px; height:30px;border: none; color: #2ccff4;">
                              </div>
                              <div class="col-lg-4">
                                   <input type="number" name="" min="1" id="qnty_8a" class="form-control"
                                        style="width: 130px; height:30px;border-radius: 5px;">
                              </div>
                              <div class="col-lg-4">
                                   <input type="" name="" value="" min="1" id="jumla_8a" autocomplete="off"
                                        class="form-control"
                                        style="width: 130px; height:30px;border: none; color: blue;">
                              </div>
                              ...
                              <div class="col-lg-4">
                                   <div class="text-center">
                                        <label for="recipient-name" class="form-control-label"><b>Total
                                                  Amount</b></label>
                                   </div>
                                   <input type="number" name="withdrow" min="1" id="jumlaa" autocomplete="off" required
                                        class="form-control" style="width: 130px; height:30px;border-radius: 5px;">
                              </div>
                              <div class="col-lg-4">
...
<div class="modal fade" id="kt_modal_2<?php //echo $blanchs->blanch_id; ?>" tabindex="-1" role="dialog"
                    ...
                    <div class="form-group">
                         <div class="row">
                              <div class="col-lg-4">
                                   ...
                                   <input type="" name="" id="amount_1s" min="1" readonly value="10000"
                                        class="form-control"
                                        style="width: 130px; height:30px;border: none; color: #2ccff4;">
                              </div>
                              <div class="col-lg-4">
                                   <label for="recipient-name" class="form-control-label">*Quantity</label>
                                   <input type="number" name="" id="qnty_1s" min="1" class="form-control"
                                        style="width: 130px; height:30px;border-radius: 5px;">
                              </div>
                              <div class="col-lg-4">
                                   <label for="recipient-name" class="form-control-label">Total Amount</label>
                                   <input type="" name="" autocomplete="off" min="1" value="" id="jumla_1s"
                                        class="form-control"
                                        style="width: 130px; height:30px;border: none; color: blue;">
                              </div>
                              ...
                              <div class="col-lg-4">
                                   <input type="" name="" value="5000" id="amount_2s" min="1" readonly
                                        class="form-control"
                                        style="width: 130px; height:30px;border: none; color: #2ccff4;">
                              </div>
                              <div class="col-lg-4">
                                   <input type="number" name="" id="qnty_2s" min="1" class="form-control"
                                        style="width: 130px; height:30px;border-radius: 5px;">
                              </div>
                              <div class="col-lg-4">
                                   <input type="" name="" id="jumla_2s" min="1" autocomplete="off" class="form-control"
                                        style="width: 130px; height:30px;border: none; color: blue;">
                              </div>
                              ...
                              <div class="col-lg-4">
                                   <input type="" name="" value="2000" id="amount_3s" min="1" readonly
                                        class="form-control"
                                        style="width: 130px; height:30px;border: none; color: #2ccff4;">
                              </div>
                              <div class="col-lg-4">
                                   <input type="number" name="" id="qnty_3s" min="1" class="form-control"
                                        style="width: 130px; height:30px;border-radius: 5px;">
                              </div>
                              <div class="col-lg-4">
                                   <input type="" name="" id="jumla_3s" min="1" autocomplete="off" class="form-control"
                                        style="width: 130px; height:30px;border: none; color: blue;">
                              </div>


                              <div class="col-lg-4">
                                   <input type="" name="" value="1000" id="amount_4s" min="1" readonly
                                        class="form-control"
                                        style="width: 130px; height:30px;border: none; color: #2ccff4;">
                              </div>
                              <div class="col-lg-4">
                                   <input type="number" name="" id="qnty_4s" min="1" class="form-control"
                                        style="width: 130px; height:30px;border-radius: 5px;">
                              </div>
                              <div class="col-lg-4">
                                   <input type="" name="" value="" autocomplete="off" min="1" id="jumla_4s"
                                        class="form-control"
                                        style="width: 130px; height:30px;border: none; color: blue;">
                              </div>
                              ...
                              <div class="col-lg-4">
                                   <input type="" name="" value="500" id="amount_5s" min="1" readonly
                                        class="form-control"
                                        style="width: 130px; height:30px;border: none; color: #2ccff4;">
                              </div>
                              <div class="col-lg-4">
                                   <input type="number" name="" id="qnty_5s" min="1" class="form-control"
                                        style="width: 130px; height:30px;border-radius: 5px;">
                              </div>
                              <div class="col-lg-4">
                                   <input type="" name="" value="" autocomplete="off" min="1" id="jumla_5s"
                                        class="form-control"
                                        style="width: 130px; height:30px;border: none; color: blue;">
                              </div>
                              ...
                              <div class="col-lg-4">
                                   <input type="" name="" value="200" id="amount_6s" min="1" readonly
                                        class="form-control"
                                        style="width: 130px; height:30px;border: none; color: #2ccff4;">
                              </div>
                              <div class="col-lg-4">
                                   <input type="number" name="" id="qnty_6s" min="1" class="form-control"
                                        style="width: 130px; height:30px;border-radius: 5px;">
                              </div>
                              <div class="col-lg-4">
                                   <input type="" name="" value="" autocomplete="off" min="1" id="jumla_6s"
                                        class="form-control"
                                        style="width: 130px; height:30px;border: none; color: blue;">
                              </div>
                              ...
                              <div class="col-lg-4">
                                   <input type="" name="" value="100" id="amount_7s" min="1" readonly
                                        class="form-control"
                                        style="width: 130px; height:30px;border: none; color: #2ccff4;">
                              </div>
                              <div class="col-lg-4">

                                   <input type="number" name="" id="qnty_7s" min="1" class="form-control"
                                        style="width: 130px; height:30px;border-radius: 5px;">
                              </div>
                              <div class="col-lg-4">

                                   <input type="" name="" value="" min="1" autocomplete="off" id="jumla_7s"
                                        class="form-control"
                                        style="width: 130px; height:30px;border: none; color: blue;">
                              </div>
                              ...
                              <div class="col-lg-4">
                                   <input type="" name="" value="50" id="amount_8s" min="1" readonly
                                        class="form-control"
                                        style="width: 130px; height:30px;border: none; color: #2ccff4;">
                              </div>
                              <div class="col-lg-4">
                                   <input type="number" name="" id="qnty_8s" min="1" class="form-control"
                                        style="width: 130px; height:30px;border-radius: 5px;">
                              </div>
                              <div class="col-lg-4">
                                   <input type="" name="" id="jumla_8s" min="1" autocomplete="off" class="form-control"
                                        style="width: 130px; height:30px;border: none; color: blue;">
                              </div>
                              ...
                              <div class="col-lg-4">
                                   ...
                                   <input type="number" name="withdrow" min="1" id="jumlas" autocomplete="off" required
                                        class="form-control" style="width: 130px; height:30px;border-radius: 8px;">
                              </div>
                              <div class="col-lg-4">
                              </div>
                              ...
                              <div class="col-lg-">
                                   ...
                                   <select type="text" name="method" class="form-control" required
                                        style="border-radius: 8px;">
                                        <option value="">Select Withdrawal Method</option>
                                        <?php foreach ($acount as $acounts): ?>
                                             <option value="<?php echo $acounts->trans_id; ?>">
                                                  <?php echo $acounts->account_name; ?></option>
                                        <?php endforeach; ?>
...
<!-- <p>deposit</p> -->
<div class="modal fade" id="kt_modal_<?php //echo $blanchs->blanch_id; ?>" tabindex="-1" role="dialog"
     aria-labelledby="exampleModalLabel" aria-hidden="true">
     <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
               <div class="modal-header">
               ...
               <div class="modal-body">
                    ...
                    <div class="form-group">
                         <div class="row">
                              <div class="col-lg-4">
                                   <label for="recipient-name" class="form-control-label"><b>Amount</b></label>
                                   <input type="" name="" id="amount_1" min="1" readonly value="10000"
                                        class="form-control"
                                        style="width: 130px; height:30px;border: none; color: #2ccff4;">
                              </div>
                              <div class="col-lg-4">
                                   <label for="recipient-name" class="form-control-label">*Quantity</label>
                                   <input type="number" name="" min="1" id="qnty_1" class="form-control"
                                        style="width: 130px; height:30px;border-radius: 5px;">
                              </div>
                              <div class="col-lg-4">
                                   <label for="recipient-name" class="form-control-label">Total Amount</label>
                                   <input type="" name="" value="" min="1" autocomplete="off" id="jumla_1"
                                        class="form-control"
                                        style="width: 130px; height:30px;border: none; color: blue;">
                              </div>
                              ...
                              <div class="col-lg-4">
                                   <input type="" name="" value="5000" min="1" id="amount_2" readonly
                                        class="form-control"
                                        style="width: 130px; height:30px;border: none; color: #2ccff4;">
                              </div>
                              <div class="col-lg-4">
                                   <input type="number" name="" id="qnty_2" min="1" class="form-control"
                                        style="width: 130px; height:30px;border: radius;border-radius: 5px;">
                              </div>
                              <div class="col-lg-4">
                                   <input type="" name="" id="jumla_2" min="1" autocomplete="off" class="form-control"
                                        style="width: 130px; height:30px;border: none; color: blue;">
                              </div>
                              ...
                              <div class="col-lg-4">
                                   <input type="" name="" value="2000" id="amount_3" min="1" readonly
                                        class="form-control"
                                        style="width: 130px; height:30px;border: none; color: #2ccff4;">
                              </div>
                              <div class="col-lg-4">
                                   <input type="number" name="" id="qnty_3" min="1" class="form-control"
                                        style="width: 130px; height:30px;border-radius: 5px;">
                              </div>
                              <div class="col-lg-4">
                                   <input type="" name="" id="jumla_3" min="1" autocomplete="off" class="form-control"
                                        style="width: 130px; height:30px;border: none; color: blue;">
                              </div>


                              <div class="col-lg-4">
                                   <input type="" name="" value="1000" id="amount_4" min="1" readonly
                                        class="form-control"
                                        style="width: 130px; height:30px;border: none; color: #2ccff4;">
                              </div>
                              <div class="col-lg-4">
                                   <input type="number" name="" id="qnty_4" min="1" class="form-control"
                                        style="width: 130px; height:30px;border-radius: 5px;">
                              </div>
                              <div class="col-lg-4">
                                   <input type="" name="" value="" id="jumla_4" min="1" autocomplete="off"
                                        class="form-control"
                                        style="width: 130px; height:30px;border: none; color: blue;">
                              </div>
                              ...
                              <div class="col-lg-4">
                                   <input type="" name="" value="500" id="amount_5" min="1" readonly
                                        class="form-control"
                                        style="width: 130px; height:30px;border: none; color: #2ccff4;">
                              </div>
                              <div class="col-lg-4">
                                   <input type="number" name="" id="qnty_5" min="1" class="form-control"
                                        style="width: 130px; height:30px;border-radius: 5px;">
                              </div>
                              <div class="col-lg-4">
                                   <input type="" name="" value="" min="1" id="jumla_5" autocomplete="off"
                                        class="form-control"
                                        style="width: 130px; height:30px;border: none; color: blue;">
                              </div>
                              ...
                              <div class="col-lg-4">
                                   <input type="" name="" min="1" value="200" id="amount_6" readonly
                                        class="form-control"
                                        style="width: 130px; height:30px;border: none; color: #2ccff4;">
                              </div>
                              <div class="col-lg-4">
                                   <input type="number" name="" min="1" id="qnty_6" class="form-control"
                                        style="width: 130px; height:30px;border-radius: 5px;">
                              </div>
                              <div class="col-lg-4">
                                   <input type="" name="" value="" min="1" id="jumla_6" autocomplete="off"
                                        class="form-control"
                                        style="width: 130px; height:30px;border: none; color: blue;">
                              </div>
                              ...
                              <div class="col-lg-4">
                                   <input type="" name="" value="100" min="1" id="amount_7" readonly
                                        class="form-control"
                                        style="width: 130px; height:30px;border: none; color: #2ccff4;">
                              </div>
                              <div class="col-lg-4">

                                   <input type="number" name="" min="1" id="qnty_7" class="form-control"
                                        style="width: 130px; height:30px;border-radius: 5px;">
                              </div>
                              <div class="col-lg-4">

                                   <input type="" name="" value="" min="1" id="jumla_7" autocomplete="off"
                                        class="form-control"
                                        style="width: 130px; height:30px;border: none; color: blue;">
                              </div>
                              ...
                              <div class="col-lg-4">
                                   <input type="" name="" value="50" min="1" id="amount_8" readonly class="form-control"
                                        style="width: 130px; height:30px;border: none; color: #2ccff4;">
                              </div>
                              <div class="col-lg-4">
                                   <input type="number" name="" min="1" id="qnty_8" class="form-control"
                                        style="width: 130px; height:30px;border-radius: 5px;">
                              </div>
                              <div class="col-lg-4">
                                   <input type="" name="" value="" min="1" id="jumla_8" autocomplete="off"
                                        class="form-control"
                                        style="width: 130px; height:30px;border: none; color: blue;">
                              </div>
                              ...
                              <div class="col-lg-4">
                                   ...
                                   <input type="number" name="depost" min="1" id="jumla" autocomplete="off" required
                                        class="form-control" style="width: 130px; height:30px;border-radius: 5px;">
                              </div>
                              <div class="col-lg-4">
                              ...
                              <div class="col-lg-3">
                                   ...
                                   <!--  <input type="number" name="withdrow" id="jumlas" autocomplete="off" required class="form-control"style="width: 130px; height:30px;border-radius: 8px;"> -->
                                   <select type="text" name="p_method" class="form-control" required
                                        style="border-radius: 8px;">
                              ...
                              <div class="col-lg-3">
                                   ...
                                   <?php } elseif ($customer_loan->loan_status == 'out') {
                                        ...
                                        <input type="text" class="form-control"
                                             value="<?php echo number_format($out_stand->total_out); ?>.00" readonly
                                             style="color:red">
                                   <?php } else { ?>
                                        <span>Recovery Amount</span>
                    ...
                    <div class="form-group">
                         <div class="row">
                              <div class="col-lg-12">
                                   ...
                                   <select class="form-control kt-selectpicker" name="customer_id" required
                                        ...
                                        <?php foreach ($customery as $customers): ?>
                                             <option value="<?php echo $customers->customer_id; ?>">
                                                  ...
                                                  echo strtoupper($customers->f_name . ' ' . $customers->m_name . ' ' . $customers->l_name);
                                                  ?>
                                             </option>
                                        <?php endforeach; ?>
                                   </select>
